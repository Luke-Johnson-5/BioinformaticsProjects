#!/modules/apps/R/4.1.2/bin/Rscript

datafile <- "/groups/bioc6242/data/csv/MetaHIT_SangerSamples.genus.txt"
data=read.table(datafile, header=T, row.names=1, dec=".", sep="\t")
data=data[-1,]

clsfile <- "/groups/bioc6242/data/csv/MetaHIT_SangerSamples.genus.cls"
