...
def main():
    ...
    in_file_one = "/groups/bioc6243/data/csv/entrotypes.csv"
    #in_file_two = "/groups/bioc6243/data/csv/MetaHIT_SangerSamples.genus.txt"
    in_file_two = "/groups/bioc6243/data/csv/MetaHIT_SangerSamples.genus.filtered.csv"
